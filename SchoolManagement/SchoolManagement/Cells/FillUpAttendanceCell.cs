...
{
    public class FillUpAttendanceCell : ViewCell
    {
        private Student model;

        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="FillUpAttendanceCell"/> class.
        /// </summary>
        public FillUpAttendanceCell()
        {
        ...
        protected override void OnBindingContextChanged()
        {
            ...
            StackLayout stack = CreateFillUpAttendanceCellLayout();
        ...
        /// <summary>
        /// Create FillUp Attendance Layout.
        /// </summary>
        public StackLayout CreateFillUpAttendanceCellLayout()
        {
